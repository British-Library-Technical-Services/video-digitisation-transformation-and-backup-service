startup_message = """[bold magenta][u]This is the File Backup Service for Offline Video Preservation[/u][/bold magenta]
...
mov_exit_message = "There are no MOV files in the staging area.  The [bold] MOV > FFV1 file transformation service will exit[/bold]."

avi_exit_message = "There are no AVI files in the staging area.  The [bold] AVI file backup service[/bold] will exit."
